...
<body>
    <p>Dear {$this->formData['first_name']} {$this->formData['last_name']},</p>
    <br><br>
    ...
    <p>If you have any questions or need assistance, please feel free to contact our support team at <a
            href='{$this->supportedMail}'>{$this->supportedMail}</a> or <a
            href='tel:{$this->supportedPhone}'>{$this->supportedPhone}</a>.</p> 
